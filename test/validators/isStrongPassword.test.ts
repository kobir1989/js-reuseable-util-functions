...
describe('isStrongPassword', () => {
  it('Should be a valid strong password', () => {
  ...
  it('Should be a valid strong password with custom requirements', () => {
  ...
  it('Should not be a valid strong password - missing uppercase - missing one more symble', () => {
  ...
  it('Should not be a valid strong password - too short', () => {
  ...
  it('Should not be a valid strong password - missing symbols', () => {
  ...
  it('Should not be a valid strong password - missing password', () => {
  ...
  it('Should not be a valid strong password - missing number', () => {
