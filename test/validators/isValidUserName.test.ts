...
test('should return false for a too short username', () => {
...
test('should return false for a too long username', () => {
  const invalidUsername = 'toolongusername1234567890'
  expect(isValidUserName(invalidUsername)).toBe(false)
})

test('should return false for usernames containing disallowed words', () => {
...
test('should return true for valid usernames even if they contain disallowed words', () => {
  const disallowedWords = ['admin', 'root', 'password']
...
test('should return false for invalid usernames if they contain disallowed words', () => {
  const disallowedWords = ['admin', 'root', 'password']
